...
currentQue = SongQue()
currentQue.add(Song('Tum hi aana', 'jubin'))
currentQue.add(Song('hamari adhuri kahani ', 'arijit'))
currentQue.add(Song('kal ho na ho', 'sonu nigam'))
currentQue.add(Song('Alvida', 'pritam'))
currentQue.add(Song('aa dil hai mushkil', 'arijit'))
currentQue.add(Song('tujh mein rab dikhta hai',
 'Jay Kadn and Roopkumar Rathod'))
